...
import io.github.kauabetineli.libraryapi.exceptions.CampoInvalidoException;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(RegistroDuplicadoException.class) // o objeto que vamos receber como parametro
